...
from CNN_with_Transformer import CBAM
...
class InceptionV2(nn.Module):
    ...
    def __init__(self, _in_channels, pth1, pth2, pth3, pth4):
        ...
        # 添加一个CBAM层
        channels = pth1 + pth2[1] + pth3[2] + pth4
        self.cbam = CBAM.CBAM(channel=channels, reduction=12, kernel_size=7)
    ...
    def forward(self, x):
        ...
        return self.cbam(torch.cat((p1, p2, p3, p4), dim=1))
